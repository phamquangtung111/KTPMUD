...
@section('content-admin')
    ...
    ?>
    <form action="{{route('SaveAccount')}}" id="submit" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
    </form>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                <div class="input-group mb-3">
                                    ...
                                    <input value="{{ old('username') }}" type="text" name="name"
                                           style="width:100%"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            <div class="input-group mb-3">
                                ...
                                <input value="{{ old('last_name') }}" type="text" name="tennv"
                                       style="width:100%"
                                       aria-describedby="inputGroup-sizing-default" class="form-control"
                                       form="submit">
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            <div class="input-group mb-3">
                                ...
                                <input value="{{ old('email') }}" type="email" name="email" style="width:100%"
                                       aria-describedby="inputGroup-sizing-default" class="form-control"
                                       form="submit">
                            </div>
                        </div>
