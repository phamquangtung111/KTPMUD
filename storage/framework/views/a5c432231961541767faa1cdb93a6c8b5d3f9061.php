<?php $__env->startSection('content-admin'); ?>
    ...
    ?>
    <form action="<?php echo e(route('UpdateEmployee')); ?>" id="submit" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a class="btn btn-outline-danger"
                                       href="/admin/delete/delete_employee/<?php echo e($data->id); ?>">Xóa</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            <div class="input-group mb-3">
                                ...
                                <select name="macv" class="w-100 custom-select  mb-2 form-control"
                                    ...
                                    <option name="macv" value="1" <?php if($data->macv == 1): ?> selected <?php endif; ?>>Nhân Viên</option>
                                    <option name="macv" value="2" <?php if($data->macv == 2): ?> selected <?php endif; ?>>Quản lý</option>
                                    <option name="macv" value="3" <?php if($data->macv == 3): ?> selected <?php endif; ?>>Trưởng Phòng</option>
                                    <option name="macv" value="4" <?php if($data->macv == 4): ?> selected <?php endif; ?>>Phó Phòng</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            <div class="input-group mb-3">
                                ...
                                <select name="mapb" class="w-100 custom-select  mb-2 form-control"
                                    ...
                                    <option name="mapb" value="0" <?php if($data->mapb == 0): ?> selected <?php endif; ?>>Kế toán</option>
                                    <option name="mapb" value="1" <?php if($data->mapb == 1): ?> selected <?php endif; ?>>Công Nghệ</option>
                                    <option name="mapb" value="2" <?php if($data->mapb == 2): ?> selected <?php endif; ?>>Ban GD</option>
                                    <option name="mapb" value="3" <?php if($data->mapb == 3): ?> selected <?php endif; ?>>Nhân sự</option>
                                    <option name="mapb" value="4" <?php if($data->mapb == 4): ?> selected <?php endif; ?>>Marketing</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            <div class="input-group mb-3">
                                ...
                                <input value="<?php echo e($data->manv); ?>" type="text" name="manv"
                                       style="width:100%"
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            <div class="input-group mb-3">
                                ...
                                <select name="gioitinh" class="w-100 custom-select  mb-2 form-control"
                                    ...
                                    <option name="gioitinh" value="0" <?php if($data->gioitinh == 0): ?> selected <?php endif; ?>>Nam</option>
                                    <option name="gioitinh" value="1" <?php if($data->gioitinh == 1): ?> selected <?php endif; ?>>Nữ</option>
                                    <option name="gioitinh" value="2" <?php if($data->gioitinh == 2): ?> selected <?php endif; ?>>Khác</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            <div class="input-group mb-3">
                                ...
                                <input value="<?php echo e($data->diachi); ?>" type="text" name="diachi"
                                       style="width:100%"
                                       aria-describedby="inputGroup-sizing-default" class="form-control"
                                       form="submit">
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            <div class="input-group mb-3">
                                ...
                                <input value="<?php echo e($data->cmnd); ?>" type="text" name="cmnd" style="width:100%"
                                       aria-describedby="inputGroup-sizing-default" class="form-control"
                                       form="submit">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            <div class="input-group mb-3">
                                ...
                                <input value="<?php echo e($data->sdt); ?>" type="text" name="sdt" style="width:100%"
                                       aria-describedby="inputGroup-sizing-default" class="form-control"
                                       form="submit">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            <div class="input-group mb-3">
                                ...
                                <input value="<?php echo e($data->ngaysinh); ?>" type="date" name="ngaysinh" style="width:100%"
                                       aria-describedby="inputGroup-sizing-default" class="form-control"
                                       form="submit">
                            </div>
                        </div>
...
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/techasians/resources/views/admin/edit/employee.blade.php ENDPATH**/ ?>