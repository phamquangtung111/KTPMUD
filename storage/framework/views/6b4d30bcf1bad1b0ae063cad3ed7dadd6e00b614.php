...
<head>
    ...
    <!--===============================================================================================-->
    <link rel="icon" type="image/png" href="<?php echo e(asset('home/img/logo/Sapo-logo.png')); ?>"/>
    <!--===============================================================================================-->
...
<style>
    #bodyLogin{
        background-image: url(<?php echo e(asset('home/img/background.png')); ?>);
...
<?php /**PATH /var/www/html/techasians/resources/views/index.blade.php ENDPATH**/ ?>